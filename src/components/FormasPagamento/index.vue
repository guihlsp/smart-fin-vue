<template>
  <div>
    ...
    <b-table
      v-if="!carregando && formasPagamento"
      striped
      hover
      ...
      <template v-slot:cell(acoes)="data">
        <div class="coluna-acoes">
          <md-button
            ...
            :to="'formas_pagamento/visualizar/' + data.item.id"
          >
            <md-icon> search </md-icon>
          </md-button>
          <md-button
            class="acoes md-primary md-dense md-just-icon"
            :to="'formas_pagamento/editar/' + data.item.id"
          >
        ...
        <md-dialog-confirm
          ...
          md-title="Formas de pagamento"
          md-content="Tem certeza que deseja excluir a forma de pagamento ?"
    ...
    <div>
      ...
      >
        <md-button to="formas_pagamento/adicionar" class="md-primary md-raised"
          >Adicionar forma de pagamento</md-button
        >
      </md-empty-state>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    excluirFormaPagamento(id) {
      this.$api
        .delete("/formas_pagamento/deletar/" + id)
        .then((response) => {
          this.$notify({
