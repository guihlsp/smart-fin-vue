                    ...
                    <div class="row">
                        <b-form-group label-for="nome" class="col-4">
                            <md-field :class="getValidationClass('nome')">
                                <label>Nome</label>
                                <md-input id="nome" type="text" v-model="form.formaPagamento.nome"
                                    autocomplete="off" :disabled="carregando">
                                </md-input>
                                <span class="md-error" v-if="!$v.form.formaPagamento.nome.required">Descrição obrigatória!</span>
                            </md-field>
                        </b-form-group>
                        ...
                        <b-form-group label-for="tipo" class="col-4">
                            <md-field :class="getValidationClass('tipo')">
                                <label>Tipo</label>
                                <md-input id="tipo" type="text" v-model="form.formaPagamento.tipo"
                                    autocomplete="off" :disabled="carregando">
                                </md-input>
                                <span class="md-error" v-if="!$v.form.formaPagamento.tipo.required">Descrição obrigatória!</span>
                            </md-field>
                        </b-form-group>
