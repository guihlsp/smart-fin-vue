<template>
  <div class="md-layout">
    ...
    <md-card>
      ...
      >
        <h4 class="title h3">
          {{ $route.path.includes("editar") ? "Editar" : "Adicionar" }} tag
        </h4>
      </md-card-header>
      <md-card-content>
          ...
          <b-form-group label-for="descricao" class="col-6">
            <md-field :class="getValidationClass('descricao')">
              ...
              <md-input
                id="descricao"
                type="text"
                v-model="form.tag.descricao"
                autocomplete="off"
                :disabled="carregando"
              >
              </md-input>
              <verte
                v-model="form.tag.cor_hexa"
                :enableAlpha="false"
                picker="square"
                model="hex"
              >
              ...
              <span class="md-error" v-if="!$v.form.tag.descricao.required"
