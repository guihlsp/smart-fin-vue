<template>
  <div>
      ...
      <template v-slot:cell(acoes)="data">
        <div class="coluna-acoes">
          <md-button
            ...
            :to="'categorias/visualizar/' + data.item.id"
          >
            <md-icon> search </md-icon>
          </md-button>
          <md-button
            class="acoes md-primary md-dense md-just-icon"
            :to="'categorias/editar/' + data.item.id"
          >
        ...
        <md-dialog-confirm
          ...
          md-title="Categorias"
          md-content="Tem certeza que deseja excluir a categoria ?"
    ...
    <div>
      ...
      >
        <md-button to="categorias/adicionar" class="md-primary md-raised"
          >Adicionar categoria</md-button
        >
      </md-empty-state>
    </div>
  </div>
