        ...
        <b-form @submit.prevent="valida" novalidate>
          ...
          <b-form-group label-for="password">
            ...
            >
              ...
              <md-icon v-if="exibeSenha"
                ><a @click="exibirSenha" style="cursor: pointer"
                  >visibility</a
                ></md-icon
              >
              <md-icon v-else
          ...
          <b-form-group>
            <div class="d-flex justify-content-between">
              <md-checkbox class="mt-0" v-model="keepLogin"
                >Manter conectado</md-checkbox
              >
              <small>
          ...
          <div class="row mt-3">
            ...
            <md-button
              type="button"
              variant="md-default outline-secondary"
              @click="cadastro()"
            >
